...
namespace cheat::game::filters
{
	...
	namespace puzzle
	{
		...
		SimpleFilter CubeDevices = { app::EntityType__Enum_1::Platform, "_ElecSwitch" };
		...
		SimpleFilter SeelieLamp = { app::EntityType__Enum_1::Field,  };
		SimpleFilter Seelie = { app::EntityType__Enum_1::Platform, std::vector<std::string> {"Gear_Seelie", "Gear_SeeliaLamp" } };
